    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sp_batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trackBottle.batch')),
                ('sp_bottle', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='trackBottle.bottle')),
                ('sp_machine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trackBottle.machine')),
            ],
        ),
    ]
